    ...
    <div class="grid">
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Bu Gün Alınan Ödeme Tutarı</span>
                ...
                <span class="text-green-500 font-medium">0 yeni </span>
                <span class="text-500">ödeme</span>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Bu Hafta Alınan Ödeme Tutarı</span>
                        <div class="text-900 font-medium text-xl">0</div>
                    </div>
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Bu Ay Alınan Ödeme Tutarı</span>
                        <div class="text-900 font-medium text-xl">0</div>
                    </div>
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Bu Yıl Alınan Ödeme Tutarı</span>
                        <div class="text-900 font-medium text-xl">0</div>
                    </div>
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Bu Gün Alınan Ödeme Adedi</span>
                        <div class="text-900 font-medium text-xl">0</div>
                    </div>
                    <div class="flex align-items-center justify-content-center bg-blue-100 border-round"
                        style="width: 2.5rem; height: 2.5rem">
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Bu Hafta Alınan Ödeme Adedi</span>
                        <div class="text-900 font-medium text-xl">0</div>
                    </div>
                    <div class="flex align-items-center justify-content-center bg-orange-100 border-round"
                        style="width: 2.5rem; height: 2.5rem">
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Bu Ay Alınan Ödeme Adedi</span>
                        <div class="text-900 font-medium text-xl">0</div>
                    </div>
                    <div class="flex align-items-center justify-content-center bg-cyan-100 border-round"
                        style="width: 2.5rem; height: 2.5rem">
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">Bu Yıl Alınan Ödeme Adedi</span>
                        <div class="text-900 font-medium text-xl">0</div>
                    </div>
                    <div class="flex align-items-center justify-content-center bg-purple-100 border-round"
                        style="width: 2.5rem; height: 2.5rem">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="flex justify-content-center">
                    <Image :src="'demo/images/galleria/galleria11.jpg'" alt="Image" style="width=5%" preview />
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <DataTable :value="products" :rows="5" :paginator="true" responsiveLayout="scroll">
                    <Column style="width: 15%">
                        <template #header> Resim </template>
                        <template #body="slotProps">
                            <img :src="'demo/images/product/' + slotProps.data.image" :alt="slotProps.data.image" width="50"
                                class="shadow-2" />
                        </template>
                    </Column>
                    <Column field="name" header="İsim" :sortable="true" style="width: 35%"></Column>
                    <Column field="price" header="Fiyat" :sortable="true" style="width: 35%">
                        <template #body="slotProps">
        ...
        <div class="col-12 xl:col-6">
            ...
            <div class="card">
                ...
                <span class="block text-600 font-medium mb-3">BU GÜN</span>
                ...
                <span class="block text-600 font-medium mb-3">DÜN</span>
