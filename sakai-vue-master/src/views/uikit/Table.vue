        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                    ...
                    <Column field="name" header="Name" style="min-width: 2rem">
                        <template #body="{ data }">
                            {{ data.name }}
                        </template>
                    ...
                    <Column header="Date" filterField="date" dataType="date" style="min-width: 1rem">
                        <template #body="{ data }">
                    ...
                    <Column header="Balance" filterField="balance" dataType="numeric" style="min-width: 1rem">
                        <template #body="{ data }">
                    ...
                    <Column field="activity" header="Activity" :showFilterMatchModes="false" style="min-width: 1rem">
                        <template #body="{ data }">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <DataTable :value="customer2" :scrollable="true" scrollHeight="400px" :loading="loading2" scrollDirection="both" class="mt-3">
                    <Column field="name" header="Name" :style="{ width: '50px' }" frozen></Column>
                    <Column field="id" header="Id" :style="{ width: '50px' }" :frozen="idFrozen"></Column>
                    <Column field="date" header="Date" :style="{ width: '100px' }"></Column>
